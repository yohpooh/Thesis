...
public class complaint_page_four_ua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complaint_page_four_ua);

        final Button done = findViewById(R.id.btnDone_complaint_page_qrCodeua);
        refcode = findViewById(R.id.refcode_ua);

        Intent intent = getIntent();
        _PLACE = intent.getStringExtra("Place_of_Incident");

        reference = FirebaseDatabase.getInstance().getReference(_PLACE).child("Unknown_Abuse");
