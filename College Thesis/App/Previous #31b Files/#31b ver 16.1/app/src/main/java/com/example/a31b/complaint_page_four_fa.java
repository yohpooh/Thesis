...
public class complaint_page_four_fa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complaint_page_four_fa);

        Intent intent = getIntent();
        _PLACE = intent.getStringExtra("Place_of_Incident");

        reference = FirebaseDatabase.getInstance().getReference(_PLACE).child("Economical_Abuse");

        final Button done = findViewById(R.id.btnDone_complaint_page_qrCodefa);
        refcode = findViewById(R.id.refcode_fa);
        ...
        showAllUserData();
            ...
            public void onClick(View view) {
               ...
               // Intent intent = new Intent(complaint_page_four_fa.this, dashboardPage.class);
                //startActivity(intent);
            }
        });
