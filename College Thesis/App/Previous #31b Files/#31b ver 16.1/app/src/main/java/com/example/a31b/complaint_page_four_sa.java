...
public class complaint_page_four_sa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complaint_page_four_sa);

        Intent intent = getIntent();
        _PLACE = intent.getStringExtra("Place_of_Incident");

        reference = FirebaseDatabase.getInstance().getReference(_PLACE).child("Sexual_Abuse");

        final Button done = findViewById(R.id.btnDone_complaint_page_qrCodesa);
        refcode = findViewById(R.id.refcode_sa);
        ...
        showAllUserData();
            ...
            public void onClick(View view) {
               ...
               // Intent intent = new Intent(complaint_page_four_sa.this, dashboardPage.class);
                //startActivity(intent);
            }
        });
